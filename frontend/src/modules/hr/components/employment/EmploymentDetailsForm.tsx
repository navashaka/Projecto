...
type EmploymentDetailsFormData = z.infer<typeof employmentDetailsSchema>
...
function EmploymentDetailsForm() {
	...
	const onSubmit = (_data: EmploymentDetailsFormData) => undefined
			...
			<Stack spacing={3}>
				<div>
					...
					<Typography color="text.secondary" variant="body2">
						Capture employee employment and banking information.
					</Typography>
				</div>
				...
				<Grid container spacing={2}>
					...
					{employmentTextFields.map(({ name, label, maxLength }) => (
